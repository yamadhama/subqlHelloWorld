...
export declare class CustomDataSourceBase<K extends string, T extends SubqlNetworkFilter, M extends SubqlMapping = SubqlMapping<SubqlCustomHandler>> implements SubqlCustomDatasource<K, T, M> {
    kind: K;
    mapping: M;
    startBlock?: number;
    assets: {
        [p: string]: CustomDataSourceAsset;
    };
