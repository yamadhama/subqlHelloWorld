...
exports.CustomDataSourceBase = exports.FileReferenceImpl = exports.RuntimeDataSourceBase = exports.SubqlNetworkFilterImpl = exports.CustomMapping = exports.Mapping = exports.CustomHandler = exports.EventHandler = exports.CallHandler = exports.BlockHandler = exports.CallFilter = exports.ChainTypes = exports.EventFilter = exports.BlockFilter = void 0;
...
__decorate([
    (0, class_validator_1.IsEnum)(types_1.SubqlHandlerKind, { groups: [types_1.SubqlHandlerKind.Block] }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsEnum)(types_1.SubqlHandlerKind, { groups: [types_1.SubqlHandlerKind.Call] }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsEnum)(types_1.SubqlHandlerKind, { groups: [types_1.SubqlHandlerKind.Event] }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_transformer_1.Transform)((handlers) => {
        return handlers.map((handler) => {
            switch (handler.kind) {
                case types_1.SubqlHandlerKind.Event:
                    return (0, class_transformer_1.plainToClass)(EventHandler, handler);
                case types_1.SubqlHandlerKind.Call:
                    return (0, class_transformer_1.plainToClass)(CallHandler, handler);
                case types_1.SubqlHandlerKind.Block:
...
__decorate([
    (0, class_validator_1.IsEnum)(types_1.SubqlDatasourceKind, { groups: [types_1.SubqlDatasourceKind.Runtime] }),
    __metadata("design:type", String)
], RuntimeDataSourceBase.prototype, "kind", void 0);
__decorate([
    (0, class_transformer_1.Type)(() => Mapping),
    (0, class_validator_1.ValidateNested)(),
    __metadata("design:type", Object)
