...
exports.getGenesisHash = exports.installDependencies = exports.createProject = void 0;
...
async function createProject(localPath, project) {
    ...
    const cloneArgs = (0, types_1.isProjectSpecV0_2_0)(project) ? ['-b', 'v0.2.0', '--single-branch'] : [];
    try {
...
async function getGenesisHash(endpoint) {
    const provider = endpoint.startsWith('ws') ? new api_1.WsProvider(endpoint) : new api_1.HttpProvider(endpoint);
